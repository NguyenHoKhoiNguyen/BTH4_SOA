...
const registerService = async (serviceName, servicePort, serviceHost = 'localhost') => {
    ...
    try {
        ...
        console.log(`✅ Service ${serviceName} registered with Consul at ${serviceHost}:${servicePort}`);
